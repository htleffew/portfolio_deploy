...
<figure>
<img src="/assets/dead-signal-ai-evals/car-scene-debrief.png" alt="Car debrief scene: Craine delivers live-generated dialogue analyzing Hargrove's behavior while the evaluator panel scores each turn on the right edge of the screen." />
...
<figure>
<img src="/assets/dead-signal-ai-evals/interview-bioscan.png" alt="The Hargrove interview scene: Victor Hargrove seated behind his desk with the BIO-SCAN biometric readout panel in the upper left showing heart rate, skin temperature, perspiration, and micro-expression analysis." />
...
<figure>
<img src="/assets/dead-signal-ai-evals/interference-suppression.png" alt="Interference suppression in action: the player typed a restricted topic and the BIO-SCAN shows a heart rate spike with ANOMALY flag while the system overwrites the transmission with a fabricated compliance response marked MODIFIED." />
