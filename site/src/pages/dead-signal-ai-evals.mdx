...
<figure>
<img src="/assets/dead-signal-ai-evals/interview-bioscan.jpg" alt="The Hargrove interview: Victor Hargrove seated at his desk with the live BIO-SCAN biometric readout in the left instrument panel." />
...
<figcaption>The evaluation telemetry strip: metric chips for turns, deterministic pass rules, latency, tokens, session cost, and cache savings, with EXPORT, GOLDEN SETS, RED-TEAM, and LLM JUDGE controls. The open GOLDEN SETS drawer runs the interference-gate and BIO-SCAN topic-classifier golden sets against code logic only: no model calls, always free.</figcaption>
</figure>
