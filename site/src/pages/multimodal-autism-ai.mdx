...
visual: "point_cloud.png"
scripts: []
---
import Band from '../components/Band.astro';
import Figure from '../components/Figure.astro';
import ApaReferences from '../components/ApaReferences.astro';
import ProfileExplorer from '../components/widgets/ProfileExplorer.astro';
...
<Figure src="/assets/multimodal-autism-ai/point_cloud.png" alt="Split-screen showing real clinical room vs glowing 3D point cloud" caption="Split-screen showing real clinical room vs glowing 3D point cloud" />
...
<Figure src="/assets/multimodal-autism-ai/fig_1.svg" alt="Figure 1" caption="Figure 1" />
...
<Figure src="/assets/multimodal-autism-ai/fig_2.svg" alt="Figure 2" caption="Figure 2" />
...
<Figure src="/assets/multimodal-autism-ai/fig_3.svg" alt="Figure 3" caption="Figure 3" />
...
A live version of that per-participant clinical view is below: select a participant to see the behavioral signals, the predicted probability, the ADOS-2 score, and the uncertainty-aware recommendation the clinical report would surface.
...
<Figure src="/assets/multimodal-autism-ai/fig_4.svg" alt="Figure 4" caption="Figure 4" />
...
<Figure src="/assets/multimodal-autism-ai/fig_5.svg" alt="Figure 5" caption="Figure 5" />
