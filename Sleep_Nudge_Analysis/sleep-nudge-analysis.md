...
description: >-
  ...
  go to sleep, often while it was the middle of their working day. Eighty
  attributed cases from the discourse-mining pipeline, sixteen of which
  explicitly contradict the directive with a stated clock time or locale,
  isolating context-blindness as the measurable defect.
