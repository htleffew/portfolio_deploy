...
Impulsive offenders (ImO) and instrumental offenders (InO) are not mutually exclusive, but the neurobiological literature draws a consistent line between them across neuroanatomical, neurochemical, neuropsychological, and neurological categories. Non-psychopathic antisocial (NPA) impulsive offending reads as largely cortical: frontal-lobe dysfunction paired with heightened reactivity. Psychopathic antisocial (PA) instrumental offending reads as largely subcortical: affective deficit and impaired aversive learning. Both psychopathy and antisociality are better treated as dimensional than categorical, and the cortical-versus-subcortical distinction opens a path toward type-specific intervention design.
...
Offenses regularly defy simple either-or categorization, with violent actions sometimes functioning as both means and ends (Bushman & Anderson, 2001). For this reason I treat psychopathy, antisociality, and offense type as dimensional rather than categorical constructs in this review. Following Müller (2010), the neurobiological markers below are considered correlational reflections of severity rather than diagnostic thresholds.
...
- **Prefrontal gray matter.** An 11% reduction in PFC gray matter has been found in individuals diagnosed with ASPD and convicted of violent or sexual offenses (Raine, Lencz, Bihrle, LaCasse, & Colletti, 2000). Reduced frontal gray matter correlates with reduced baseline autonomic activity, but the finding is shared across both offender groups.
- **Temporal lobe volume.** Dolan, Deakin, Roberts, and Anderson (2002) reported an average 20% volume reduction in the temporal lobes of NPA individuals, without extension into the hippocampus or amygdala. This is one of the cleaner morphological markers of ImO.
- **Uncinate fasciculus.** Craig et al. (2009) found significantly lower fractional anisotropy, a measure of white-matter integrity, in the uncinate fasciculus, the connection between OFC and amygdala, in NPA individuals. Degradation of this tract is associated with pediatric impulsivity and likely contributes to adult impulsivity.
- **Corpus callosum.** Raine et al. (2003) found the corpus callosum to be approximately 22.6% larger in perpetrators of psychopathic instrumental offending, suggesting interruption of the typical developmental pruning of this structure and delayed inhibitory communication between hemispheres.
- **Acquired aggression.** Aggression acquired through damage to frontal cortex, in particular right PFC (Müller, Schuierer, Marienhagen, Putzhammer, & Klein, 2003), OFC (Blair & Cipolotti, 2000; Mitchell, Avny, & Blair, 2006), ventromedial frontal (Grafman et al., 1996), or prefrontal regions (Barrash, Tranel, & Anderson, 2000) reliably presents as reactive, impulsive aggression, not as InO. Frontal lobe lesions do not universally produce aggression (Mataró et al., 2001), but when they do, the phenotype is consistently ImO, supporting the cortical reading of NPA and the separate, subcortical reading of PA.
...
Treating both NPA and PA as dimensional, not categorical, conditions has a clinical consequence: neither group represents persons who are categorically different from the rest of the population, and group-specific protocols become a coherent design goal. NPA interventions would aim at improving executive functioning and neural connectivity while down-regulating affective reactivity; PA interventions would aim at addressing affective deficits, impaired aversive learning, and limited receptivity to conditioning.
